...
type CreateAsyncThunk<CurriedThunkApiConfig> = {
   ...
   * @public
   */
  <Returned, ThunkArg, ThunkApiConfig extends CurriedThunkApiConfig>(
    typePrefix: string,
    payloadCreator: AsyncThunkPayloadCreator<
      Returned,
      ThunkArg,
  ...
  forTypes<
    ThunkApiConfig extends CurriedThunkApiConfig
...
If you want to use the AbortController to react to \`abort\` events, please consider importing a polyfill like 'abortcontroller-polyfill/dist/abortcontroller-polyfill-only'.`
  ...
  createAsyncThunk.forTypes = createAsyncThunk as unknown
